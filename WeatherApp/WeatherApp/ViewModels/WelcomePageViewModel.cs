    ...
    public class WelcomePageViewModel: BaseViewModel
    {
        ...
        private async Task SaveLocationAndPlacemark(Location location, Placemark placemark)
        {
            var loc = new LocationModel()
            {
                ...
                Locality = placemark.Locality,//"Moscow",
                CountryName = placemark.CountryName,//"Russia",
                Selected = true
            };
        ...
        {
            (string WeatherApiBaseUrl, string WeatherApiKey) localSettings =
                ("https://api.openweathermap.org/data/2.5",
                "e60a227a4667049d23504904815bdd54");//_localSettingsService.LoadLocalSettings();
